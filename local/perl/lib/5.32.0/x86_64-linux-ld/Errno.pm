...
"x86_64-linux-ld-4.15.0-151-generic" or
	die "Errno architecture (x86_64-linux-ld-4.15.0-151-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
